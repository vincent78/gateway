...
public class ServiceVerticle extends VerticleBase {
    ...
    public void registService(Message msg) {
        ...
        manager.registServiceRoute(new HttpRouteModel(HttpRouteType.GET, SVConstant.EVENT_TIMESTAMP, root + "/timestamp", true));
        manager.registServiceRoute(new HttpRouteModel(HttpRouteType.GET, SVConstant.EVENT_CLUSTER_BROKERS_INFO, root + "/brokers", true));
